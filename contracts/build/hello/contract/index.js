...
export class Contract {
    ...
    this.circuits = {
      proveThreshold: async (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(value_0).concat(_descriptor_0.toValue(threshold_0)),
  ...
  async _proveThreshold_0(context, partialProofData, value_0, threshold_0) {
    const tmp_0 = 1n;
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
...
export const expectedVk = {
  'proveThreshold': 'e00145178299964d72d810f7352714213fe357477e092135865b07b2f49bf6ae',
};
